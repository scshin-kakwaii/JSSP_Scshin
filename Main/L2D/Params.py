...
# args for PPO - "SAFE MODE" SETTINGS
...
parser.add_argument('--lr', type=float, default=2e-5, help='Learning rate (Safe Start)')
...
parser.add_argument('--entloss_coef', type=float, default=0.05, help='entropy loss coefficient (Moderate Start)')
