...
# args for env
parser.add_argument('--n_j', type=int, default=5, help='Number of jobs of instance')
...
# CRITICAL FIX: Increased learning rate for faster learning
parser.add_argument('--lr', type=float, default=3e-4, help='Learning rate (increased from 2e-5)')
...
parser.add_argument('--decay_ratio', type=float, default=0.9, help='decay_ratio')
parser.add_argument('--gamma', type=float, default=1, help='discount factor')

# CRITICAL FIX: Increased k_epochs for better policy updates
parser.add_argument('--k_epochs', type=int, default=4, help='update policy for K epochs (increased from 1)')
...
# CRITICAL FIX: Increased entropy coefficient to encourage exploration
parser.add_argument('--entloss_coef', type=float, default=0.05, help='entropy loss coefficient (increased from 0.01)')
